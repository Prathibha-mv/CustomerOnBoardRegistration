...
<tr><td><font color=black size=4 face="Verdana">PHONE NUMBER :    </font></td><td>  <input type="text" name="contact"  onclick="this.value=''"/></td></tr>
<tr><td><font color=black size=4 face="Verdana">COMPANY :    </font></td><td>  <input type="text" name="Company"  onclick="this.value=''"/></td></tr>
<tr><td><font color=black size=4 face="Verdana">EMAIL ID :     </font> </td><td>  <input type="text" name="Email"  onclick="this.value=''"/></td></tr>
<tr><td><font color=black size=4 face="Verdana">PASSWORDS :   </font></td><td>  <input type="password" name="Password" onclick="this.value=''"/></td></tr>
